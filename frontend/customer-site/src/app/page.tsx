      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Schedule and manage your service appointments with ease. 
            Professional technicians for all your home service needs.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <h3 className="text-lg font-semibold mb-2">Qualified Technicians</h3>
              <p className="text-gray-600">Skilled professionals for every service type</p>
            </div>
